...
import "./react-dom-DMGCgcj7.js";
import { nt as useRouter, tt as useRouterState } from "./index.dev-CcgRe2z2.js";
import { t as require_jsx_runtime } from "./jsx-runtime-DmKz7Ciu.js";
import "./shim-DaBAf7X2.js";
import { S as render, a as ShadowDomTargetContext, m as createSignal, t as DevtoolsOnCloseContext, u as createComponent, v as lazy } from "./context-D56_tqst-BiBzj16p.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-B12ktJLj-Xh7ukmCP.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) BaseTanStackRouterDevtoolsPanel = this.#Component;
				...
				BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-B43j38ty-yjrdZDgx.js"));
